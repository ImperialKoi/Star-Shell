...
class SessionManager:
    ...
    def display_welcome(self):
        ...
        welcome_text = Text()
        welcome_text.append("Welcome to Shell Genie Chat Mode!\n\n", style="bold blue")
        ...
        self.console.print(Panel(
            welcome_text,
            title="[bold blue]Shell Genie Chat[/bold blue]",
            border_style="blue",
            padding=(1, 2)
        ))
    ...
    def start_conversation(self):
        ...
        self.console.print("[green]Thanks for using Shell Genie![/green]")